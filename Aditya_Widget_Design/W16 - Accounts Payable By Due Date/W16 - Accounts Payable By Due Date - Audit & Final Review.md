# W16 — Accounts Payable By Due Date — Audit & Final Review
...
|---|---|
| **Widget number** | W16 |
| **Widget name** | Accounts Payable By Due Date |
...
| **Final Design doc (Step 4 — reference when Step 6 is silent)** | [`Step 4 - Widget Final Design/W16 - Accounts Payable By Due Date.md`](../../Step%204%20-%20Widget%20Final%20Design/) |
| **Widget Spec doc (Step 3 — full history & rejected ideas)** | [`Step 3 - Mock_Work/Widget_Specs/W16-Accounts-Payable-By-Due-Date.md`](../../Step%203%20-%20Mock_Work/Widget_Specs/) |
| **Research doc (Step 1 — legacy baseline)** | [`Step 1 - Dashboard Research/16 - Accounts Payable By Due Date.md`](../../Step%201%20-%20Dashboard%20Research/) |
