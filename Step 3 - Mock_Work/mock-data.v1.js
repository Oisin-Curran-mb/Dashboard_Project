/* =============================================================
 * SNAPSHOT — NOT LIVE
 * Version: v1 (data)  |  Captured: 2026-07-07
 * Superseded by the inline MOCK_DATA block in Dashboard Widget Mockups.html.
 * Every difference from the live build traces to a documented decision made
 * afterward (Weekly Period View added, Pension's Fiscal Year filter removed,
 * FY2026 partial-month fix, payroll category changes, etc.) — see
 * "Mock_work/00 - INDEX.md" for the full comparison. Nothing here is missing
 * from the live build; this file is historical reference only.
