...
**Module:** Finance
**Status:** 🟢 Final design — locked · **v2.0 (2026-08-30): FINAL BUILT, a 1-to-1 port of Jo Lopez's Bank Balances block, per direct instruction ("copy over 1 to 1 while fitting her style, Jo's version as it just better"). Tagged v2.0 in the build; `fcInitState(15,'F')` makes it the Final Check default.**
