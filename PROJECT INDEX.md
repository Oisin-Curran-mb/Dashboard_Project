...
**2026-09-07 status sync (per direct instruction):** Steps 1-5 are marked Complete for all 14 buildable widgets (W01-W07, W09-W11, W13, W15-W17) across the Step indexes and Dashboard Tracker.xlsx. Step 5 V2 specs are Done - awaiting sign-off: drafting is complete and lint-clean, owner review pending; spec headers now say exactly that. W08/W12/W14 unchanged (deferred / empty slot / not past Step 3). Full findings and open questions: Step 3 - Mock_Work/Unattended Run - Decisions and Questions (2026-08-30).md and Dashboard Update Log.md. **Also per direct instruction 2026-09-07: W08 My Status and W14 Main Content Tasks are Completed by Jo (Steps 3-6), her own builds; permanently out of this project's scope, never ported or modified here.**
...
| 8 | 08 | My Status | ✅ Completed by Jo (her build; out of scope, no Step 4 doc) |
| 9 | 09 | Payroll Scheduled Time Off | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W09%20-%20Payroll%20Scheduled%20Time%20Off.md) |
| 10 | 10 | Loans With Balance Due | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W10%20-%20Loans%20With%20Balance%20Due.md) |
| 11 | 11 | Fixed Asset Values | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W11%20-%20Fixed%20Asset%20Values.md) |
| 12 | 13 | Purchasing Management | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W13%20-%20Purchasing%20Management.md) |
| 13 | 14 | Main Content Tasks | ✅ Completed by Jo (her build; out of scope, no Step 4 doc) |
| 14 | 15 | Bank Balances | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W15%20-%20Bank%20Balances.md) |
| 15 | 16 | Accounts Payable By Due Date | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W16%20-%20Accounts%20Payable%20By%20Due%20Date.md) |
| 16 | 17 | Gifts Pledges | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W17%20-%20Gifts%20Pledges.md) |
...
| 4 | [`Step 4 - Widget Final Design/`](Step%204%20-%20Widget%20Final%20Design/00%20-%20INDEX.md) | The ONE living doc per widget that's reached design lock — must always match what's actually built in Step 3's HTML. A widget only leaves "in progress" once it's been checked against the real build (via the `widget-final-check-audit` skill), not just because its own header says "locked." **Upgraded template adopted 2026-07-27** (see `TEMPLATE PROPOSAL - Upgraded Widget Doc.md` in that folder): evidence marks, Data Contract, Widget States, Interaction Spec, Accessibility, Sign-off Input (Jo), and a per-doc Sign-off Readiness table. 12 docs restructured that day (W01/W02 additive-only; W04–W17 in-progress group fully; W03/W07 deliberately untouched as Step 6-finished). |
...
| 6 | [`Step 6 - Sign off document/`](Step%206%20-%20Sign%20off%20document/00%20-%20INDEX.md) | **New, 2026-07-21.** Management's own sign-off documents, exported from Confluence — **never edited by anyone working in this project.** Corresponds to `Dashboard Tracker.xlsx`'s Step 6 — Design Sign Off column (the tracker's actual last step). Contains management's own independent research and findings, which can and do diverge from what Steps 3–4 assumed. Mainly affects Step 5, since that's where backend assumptions get written down concretely — see that folder's own index for two live examples already found. **As of 2026-07-27, ALL 17 widgets' Confluence dossier pages are pulled here** as dated read-only `.html` snapshots (one subfolder per widget, alongside the two original `.doc` exports); 15 of 17 were last modified 2026-07-23, making them newer than both `.doc`s. Findings from these are handled as attributed input with a status — Accepted / Rejected / Disputed (both sides' evidence kept) / Unreviewed — never as automatic corrections to Steps 1–5. |
...
│   ├── 00 - INDEX.md
│   ├── TEMPLATE PROPOSAL - Upgraded Widget Doc.md   ← adopted template, 2026-07-27
│   └── W01 - Budget Compared to Actual.md … W17 - Gifts Pledges.md   (14 files — W08, W12, W14 don't exist yet; 12 restructured to the upgraded template 2026-07-27, W03/W07 left as-is)
...
└── Step 6 - Sign off document/                 ← NEW, 2026-07-21 — management's own exports + Confluence pulls, never edited
    ...
    │   ├── Payroll+Distributions.doc
    │   ├── Payroll Distributions (Confluence pull 2026-07-27).html
    │   ├── Reconciliation - Payroll Distributions.md
    │   └── Payroll Distributions - API Spec.md + (Confluence).html
    ├── Deposit On Hand (Deposit Accounts)/
    │   ├── Deposits+On+Hand.doc
    │   └── Deposits On Hand (Confluence pull 2026-07-27).html
    └── <one subfolder per remaining widget, W01…W17 incl. W08/W12/W14>/   ← NEW 2026-07-27
        └── <Title> (Confluence pull 2026-07-27).html            (17 dossier snapshots total; see Step 6's own index for the full table)
```
...
| 08 | My Status | Other | ✅ | — none found | [spec — ⏸️ deferred](Step%203%20-%20Mock_Work/Widget_Specs/W08-My-Status.md) | ✅ Completed by Jo | ✅ Completed by Jo | ✅ Completed by Jo |
| 09 | Payroll Scheduled Time Off | Payroll | ✅ | ✅ UX tracker | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W09-Payroll-Scheduled-Time-Off.md) | ✅ Complete | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W09%20-%20Payroll%20Scheduled%20Time%20Off.md) | ✅ [Done - awaiting sign-off](Step%205%20-%20API%20documents/Payroll%20Scheduled%20Time%20Off/v2/) |
| 10 | Loans With Balance Due | Finance | ✅ | ✅ Ben Lane | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W10-Loans-With-Balance-Due.md) | ✅ Complete | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W10%20-%20Loans%20With%20Balance%20Due.md) | ✅ [Done - awaiting sign-off](Step%205%20-%20API%20documents/Loans%20With%20Balance%20Due/v2/) |
| 11 | Fixed Asset Values | Finance | ✅ | ✅ UX tracker | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W11-Fixed-Asset-Values.md) | ✅ Complete | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W11%20-%20Fixed%20Asset%20Values.md) | ✅ [Done - awaiting sign-off](Step%205%20-%20API%20documents/Fixed%20Asset%20Values/v2/) |
| 12 | *(Empty Slot)* | Other | ✅ | — N/A | [spec — removed slot](Step%203%20-%20Mock_Work/Widget_Specs/W12-None.md) | ⚪ Not started | ➖ N/A | ➖ N/A |
| 13 | Purchasing Management | Finance | ✅ | ✅ UX tracker | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W13-Purchasing-Management.md) | ✅ Complete | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W13%20-%20Purchasing%20Management.md) | ✅ [Done - awaiting sign-off](Step%205%20-%20API%20documents/Purchasing%20Management/v2/) |
| 14 | Main Content Tasks | Other | ✅ | ✅ Ben Lane, UX tracker | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W14-Main-Content-Tasks.md) | ✅ Completed by Jo | ✅ Completed by Jo | ✅ Completed by Jo |
| 15 | Bank Balances | Finance | ✅ | ✅ Ben Lane | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W15-Bank-Balances.md) | ✅ Complete | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W15%20-%20Bank%20Balances.md) | ✅ [Done - awaiting sign-off](Step%205%20-%20API%20documents/Bank%20Balances/v2/) |
| 16 | Accounts Payable By Due Date | Finance | ✅ | ⚠️ indirect only | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W16-Accounts-Payable-By-Due-Date.md) | ✅ Complete | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W16%20-%20Accounts%20Payable%20By%20Due%20Date.md) | ✅ [Done - awaiting sign-off](Step%205%20-%20API%20documents/Accounts%20Payable%20By%20Due%20Date/v2/) |
| 17 | Gifts & Pledges | Finance | ✅ | ✅ UX tracker | [spec](Step%203%20-%20Mock_Work/Widget_Specs/W17-Gifts-Pledges.md) | ✅ Complete | ✅ [Complete](Step%204%20-%20Widget%20Final%20Design/W17%20-%20Gifts%20Pledges.md) | ✅ [Done - awaiting sign-off](Step%205%20-%20API%20documents/Gifts%20Pledges/v2/) |
...
**Step 6 isn't a column in this table yet** (added too recently to restructure this table in the same pass) — but as of 2026-07-27 **every widget has Step 6 material**: all 17 Confluence dossier pages are pulled into [`Step 6 - Sign off document/`](Step%206%20-%20Sign%20off%20document/00%20-%20INDEX.md) as dated read-only snapshots (see that index's full table with page ids). Two widgets additionally have management's original `.doc` exports: **W03 Payroll Distributions** and **W07 Deposit Accounts** (renamed by management to "Deposits On Hand," rename not yet executed across this project). W03 has a `Reconciliation - Payroll Distributions.md` there, naming four real contradictions between management's review and Steps 3–5 (including why W03's Step 5 spec was just reopened to draft) — found but not yet fixed in Steps 1–5's actual content. No reconciliation files exist yet for the 15 newly-pulled dossiers; W01's is the most pressing since its page contains a direct "Review of the W01 redesign" section. Also new 2026-07-27: three cross-source conflicts found during the Step 4 template upgrade are logged as decision questions in `Step 3 - Mock_Work/Final Check - Items Needing Your Review.md` (W17 % Due definition, W05 fourth KPI tile, W04 KPI-size filter), and `Step 3 - Mock_Work/final-check-rules.py` (companion to `check-rules.py`) now gates final-widget builds via the `build-final-widget` skill.
