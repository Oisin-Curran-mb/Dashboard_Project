...
- **Sub-period actuals feasibility:** Day and Week ACTUALS cannot come from `GLSummary` (it is period-grain); they require transaction-level querying or a new day-grain rollup. Genuinely new backend work that needs a real feasibility answer before the day/week grains ship against live data.
